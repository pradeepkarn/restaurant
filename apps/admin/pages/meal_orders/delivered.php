        ...
        <div class="col-12">
          <div class="card mb-4">
            ...
            <div class="card-body pb-2">
              ...
              $db = new Dbobjects;
              $orders = $db->show("select * from payment where is_delivered=1 and (deliver_by!='' OR deliver_by!='0');");
            ...
            //   $restaurant_list = $userObj->filter_index(array('is_active' => true));
              foreach ($orders as $ol) {
                ...
                $driv_to_cust_dist = isset($odtls->driver_from_customer_km)?$odtls->driver_from_customer_km:null;
                $driv_to_rest_dist = isset($odtls->driver_from_rest_km)?$odtls->driver_from_rest_km:null;
                // myprint($odtls);
              ?>
                    <tr>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>Driver from restaurant: <?php echo $driv_to_rest_dist; ?>KM</td>
                        <td>Driver from customer: <?php echo $driv_to_cust_dist; ?>KM</td>
                      </tr>
                    <?php 
              }
                    ?>
