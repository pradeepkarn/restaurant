                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#acceptOrderModal<?php echo $pl->id; ?>">Accept this order</button>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body mod_or">
                                                ...
                                                <?php pkAjax("#accept-this-order{$pl->id}","/accept-order-by-driver",".accept-order-data{$pl->id}","#res{$pl->id}"); ?>
                                            </div>
                                        </div>
                                    </div>
                                </div>
