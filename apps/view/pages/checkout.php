    ...
    <div class="row">
      ...
      <div class="col-xxl-6 col-xl-6 col-lg-12 col-md-12 col-sm-12 coup_form mb-3">
        <div class="row">
          ...
          <div class="col-md-6">
            <input id="lat_save" type="hidden" placeholder="Latitude" class="form-control" name="lat" value="">
          </div>
          <div class="col-md-6">
            <input id="lon_save" type="hidden" placeholder="Longitude" class="form-control" name="lon" value="">
          </div>
        </div>
        <div class="row g-3">
