...
<div class="container-fluid checkout_banner mt-5">
    <div class="row">
        <div class="col-12 text-center pt-5 pb-5 check_new">
            <h2>Food Listing</h2>
            <p>Home / <span>Food Listing Edit</span></p>
        </div>
    </div>
</div>
        ...
        <div class="col-8 ps-4 coup_form">
            <div class="row g-3 mb-2">
                <div class="col-12 coupon_cl">
                    <h4 class="m-0"><?php echo $food->title; ?></h4>
                </div>
                <form id="food_up_form" action="/<?php echo home; ?>/update-food-ajax" method="POST" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" placeholder="Item Name" name="food_name" value="<?php echo $food->title; ?>" class="form-control" id="validationDefault05">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="validationDefault01" class="form-label">Item Price</label>
                            <input type="text" placeholder="Item Price" name="food_price" value="<?php echo $food->price; ?>" class="form-control" id="validationDefault06">
                        </div>
                        <div class="col-md-12 mb-3">
                            <label for="validationDefault01" class="form-label">Item Description</label>
                            <textarea type="text" placeholder="Item Description" name="food_desc" rows="5" class="form-control" id="validationDefault07"><?php echo $food->content; ?></textarea>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="validationDefault01" class="form-label">Ingridients (Optional)</label>
                            <input type="text" name="food_ingridients" value="<?php echo $food->content_info; ?>" placeholder="Ingridients (Optional)" class="form-control" id="validationDefault08">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="validationDefault01" class="form-label">Dietary Information (optional)</label>
                            <input type="text" name="food_info" value="<?php echo $food->other_content; ?>" placeholder="Dietary Information (optional)" class="form-control" id="validationDefault09">
                        </div>
                        <div class="col-md-12">
                    ...
                    <div id="up_food"></div>
                    <button class="btn btn-outline-success" id="foodup_btn">UPDATE</button>
