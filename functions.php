...
function add_to_cart($id, $action = "add_to_cart", $rest_id = 0)
{
...
// $startLat = 26.180006936125913;
// $startLong =  86.0077261820532;

// $endLat = 26.178929423207702;
// $endLong = 86.0090971749773;
